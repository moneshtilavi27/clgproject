...
<div class="page-content container-fluid">
    <div class="footer">
        <div class="d-flex justify-content-between">
            <h2 class="text-left" style="font-weight: 600">PROFILE</h2><a href="#" class="align-left"><i
...
<main class="page-content">
    <div class="container-fluid">
        <div class="row mt-3">
            ...
            <div class="col-md-10 ">
                <div class="offset-md-11"><a
                        href="<?php echo base_url('Admin/facultyUpdate/').$row[0]->fid; ?>"" class=" btn btn-info
                        btn-sm">Update</a></div>
                    ...
                    <div class="row ">
                        <div class="col-md-4 p-4" style="background-color:#efefef;">
                            <h6 class="text-center">Adhar Card<h6>
                                    <img src="<?php echo $row[0]->adhar;?>" class="img-rounded document-img img-fluid"
                                        alt="img">
                        </div>
                        <div class="col-md-4 p-4" style="background-color:#efefef;">
                            <h6 class="text-center">Bank Passbook<h6>
                                    <img src="<?php echo $row[0]->bank_doc;?>"
                                        class="img-rounded document-img img-fluid" alt="img">
                        </div>
                        <div class="col-md-4 p-4" style="background-color:#efefef;">
                            <h6 class="text-center">Pan Card<h6>
                                    <img src="<?php echo $row[0]->pan;?>" class="img-rounded document-img img-fluid"
                                        alt="img">
                        </div>
                    </div>
                </div>
